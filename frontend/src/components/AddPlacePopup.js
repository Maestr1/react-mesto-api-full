...
export default function AddPlacePopup({ isLoading, onAddPlace, onClose, isOpen }) {
  ...
  return (
    <PopupWithForm isLoading={ isLoading } onSubmit={ handleSubmit } onClose={ onClose } isOpen={ isOpen }
      ...
      <FormInput value={ name } onChange={ handleChangeName } name="placeName" type="text" placeholder="Название"
                 id="placeName"
                 minLength="2" maxLength="30"/>
      <FormInput value={ link } onChange={ handleChangeLink } name="placeLink" type="url"
